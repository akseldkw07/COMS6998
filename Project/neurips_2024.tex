...
\subsection{Benchmarking Protocol and Evaluation Metrics}
...
The first step is drafting an eval config that results in optimal baseline performance. For example, most
benchmarks expect a single-token response. In the absence of additional instruction, the LLM tends to produce
