...
\hypertarget{ref:benchmark-results}{}The full table of benchmarking results is included in the Appendix as
Figure~\ref{fig:benchmark-results}.
...
% NOTE: the caption below contains a reverse hyperlink back to the single
% in-text reference at \hypertarget{ref:benchmark-results}{...} in §3.6. If a
% second forward reference to fig:benchmark-results is ever added elsewhere,
% add another hyperlink to the new reference and disambiguate the two with \hyperlink{ref:benchmark-results-2}{...}
\begin{figure}[H]
		\centering
		\includegraphics[width=0.95\textwidth]{./aksel_img/benchmark-table-all.png}
		\caption{The full benchmark result table. (\protect\hyperlink{ref:benchmark-results}{back to reference})}
